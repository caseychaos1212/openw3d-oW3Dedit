...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent) {
    ...
    auto importJsonBatchAct = new QAction(tr("Import JSON Batch..."), this);
    batchMenu->addAction(importJsonBatchAct);
    connect(importJsonBatchAct, &QAction::triggered,
        this, &MainWindow::on_actionImportJsonBatch_triggered);
